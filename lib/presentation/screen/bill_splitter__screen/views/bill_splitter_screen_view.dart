...
import '../../debit_screen_/controllers/debit_screen_controller.dart';
...
class BillSplitterScreenView extends GetView<BillSplitterScreenController> {
  ...
  Widget build(BuildContext context) {
    if (arguments != null) {
      if (arguments is Map) {
        ...
        //     amount: amount.value,
        //     numOfParticipants: controller.listOfPayees.length);
      }
    }
      ...
      body: Obx(
        () => Column(
          children: [
            ...
            amountDisplay(screenSize, controller.debitController),
  ...
  Center amountDisplay(Size screenSize, DebitScreenController? debitContoller) {
    return Center(
      child: Card(
  ...
  Container payorList(Size screenSize, BillSplitterScreenController controller,
    ...
    return Container(
        ...
        child:
          ...
          itemCount: controller.listOfPayees
              .length, //controller.payeeController?.selectedPayees.length ?? 0,
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                // Obx(() {
                                //   return
                                Text(controller.listOfPayees[index].name),
                                //'${controller.payeeController?.selectedPayees[index].name}');
                                // }
                                // ),
                              ],
                            ),
                            ...
                            Container(
                                ...
                                child:
                                  ...
                                  controller: controller
                                      .listOfTextEditingConttoller[index],
                                  style: const TextStyle(
                                ...
                                Expanded(
                                    ...
                                    child: Container(
                                      ...
                                      child:
                                          ...
                                          Text(
                                              '${controller.listOfPayees[index].percentage ?? 0} %'),
                                      // TextField(
                                      //   style: const TextStyle(
                                      //       fontSize: 16,
                                      //       fontWeight: FontWeight.bold),
